            ...
            <div className="mx-auto max-w-3xl">
                <header className="flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-lg font-extrabold tracking-tight text-[#172033]">
                            ShopHub
                        </span>
                    </div>
                    {onCancel && (
                ...
                <section className="mt-8 overflow-hidden rounded-3xl border border-[#ded9cf] bg-white shadow-[0_20px_55px_rgba(23,43,77,0.08)]">
                    <div className="border-b border-[#eeeae2] bg-[#101a30] px-5 py-6 text-white sm:px-8">
                        <p className="font-mono-label text-[10px] tracking-[0.15em] text-[#9edcc9]">
                            STORE SETUP
                        </p>
...
function Field({
    ...
    return (
        <label
            className={`block text-xs font-bold text-[#42526e] ${className ?? ""}`}
        >
            {label}
            {children}
            {error ? (
                <span className="mt-1.5 block text-[11px] font-medium text-[#d6503b]">
                    {error}
                </span>
            ) : hint ? (
...
function Detail({
    ...
    return (
        <div className={className}>
            ...
            <dd className="mt-1 break-keep font-semibold leading-5 text-[#172033]">
                {value}
            </dd>
        </div>
    )
